...
// ***********************************************************************
// <copyright file="FdApplianceRepo.cs" company="xFusion Digital Technologies Co., Ltd">
//     Copyright ©  2019
// </copyright>
// <summary></summary>
// ***********************************************************************
...
", RegexOptions.Multiline | RegexOptions.IgnorePatternWhitespace);
                ...
                if (appliance.EventPd.Contains(appliance.EventUserName))
                {
                    return Result.Failed(1001, "The event password can not contain event username.");
                }

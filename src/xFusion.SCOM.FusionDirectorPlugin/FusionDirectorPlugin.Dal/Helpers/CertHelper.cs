...
namespace FusionDirectorPlugin.Dal.Helpers
{
    public class CertHelper
    {
        ...
        public static X509Certificate2 GetCertByPath(string certFilePath)
        {
            return new X509Certificate2(File.ReadAllBytes(certFilePath));
        }
        ...
        {
            X509Certificate2 cert = new X509Certificate2(certFilePath, pd, 
